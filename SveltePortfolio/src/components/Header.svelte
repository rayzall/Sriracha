<script>
    ...
    export let tabs = [
        ...
        { name: "FAQs", link: "https://www.youtube.com/watch?v=dQw4w9WgXcQ" },
    ];
</script>
...
>
    <h1 class="font-medium">
        <b class="font-bold poppins">Malit,</b> <span class="">Jared Raine P.</span>
    </h1>
    <div class="sm:flex items-center gap-4 hidden">
        ...
        {/each}
        <a href="https://www.facebook.com/JaredRaineMalit1142003/">
        <button
